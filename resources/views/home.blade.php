            ...
            <nav class="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
                <div class="flex lg:flex-1">
                    <a href="#" class="-m-1.5 p-1.5">
                        <span class="sr-only">Arsalan Spp</span>
                        <img class="h-8 w-auto" src="imgs/logoBlue.png" alt="logo">
                    </a>
                </div>
        ...
        <div class="relative isolate px-6 pt-14 lg:px-8">
            ...
            <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
                <div class="text-center">
                    <h1 class="text-5xl font-semibold tracking-tight text-balance text-gray-900 sm:text-7xl">Transaction
                        SPP managemant System</h1>
                    ...
                    <div class="mt-10 flex items-center justify-center gap-x-6">
                        <a href="/login"
                            ...
                            started</a>
                        <a href="/dashboard" class="text-sm/6 font-semibold text-gray-900">Learn more <span
